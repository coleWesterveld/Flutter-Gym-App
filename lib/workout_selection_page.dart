...
void didChangeDependencies() {
  ...
  int toExpand(){
    ...
    int index = daysBetween(origin , today) % context.watch<Profile>().splitLength;
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  gradient:LinearGradient(
                    ...
                    color: todaysWorkout ?  context.watch<Profile>().split[index].dayColor: const Color(0xFF1e2025),
